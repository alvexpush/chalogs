...
const users: any[] = [
  ...
  },
  {
    ...
    username: "Martin Castillo",
    email: "alvaradomartin661@yahoo.com",
    phone: "",
    kyc_status: "VERIFIED",
    preferred_currency: "USD", // Balance and values should default to USD ($)
    balance: 554000.0, // Savings + Checking
    savings_balance: 275000.0,
    checking_balance: 279000.0,
    role: "USER",
    status: "ACTIVE",
    pin: "2090",
    password: "cupcake123456",
    date_of_birth: "August 5, 1968",
    country: "US",
    state: "California",
    city: "Los Angeles",
    gender: "Male",
    occupation: "Chauffeur",
    full_address: "PO Box #132",
...
let transfers = [
  {
    ...
    amount: 150000.00,
    recipient_name: "Escrow Settlement Ledger",
    recipient_bank: "JPMorgan Chase",
    recipient_account_number: "9513637590",
    description: "Escrow Transfer Verification",
    status: "COMPLETED",
    created_at: "2026-06-06T21:42:38.306Z",
  ...
  },
  {
    ...
    transfer_type: "EXTERNAL",
    amount: 2850.00,
    recipient_name: "Executive Chauffeur Service Credit",
    recipient_bank: "JPMorgan Chase",
    recipient_account_number: "9513637590",
    description: "Private Chauffeur Service Payment",
    status: "COMPLETED",
  ...
  },
  {
    ...
    transfer_type: "EXTERNAL",
    amount: 325.00,
    recipient_name: "California Auto Insurance",
    recipient_bank: "Bank of America",
    recipient_account_number: "884210397",
    description: "Commercial Vehicle Insurance Premium",
    status: "COMPLETED",
    created_at: "2026-06-05T17:25:00.000Z",
    from_account: "checking",
  },
  {
    id: 22,
    ...
    amount: 1240.00,
    recipient_name: "Client Transportation Deposit",
    recipient_bank: "Chase Mobile",
    recipient_account_number: "9513639346",
    description: "Corporate Transportation Deposit",
    status: "COMPLETED",
    created_at: "2026-06-05T14:40:00.000Z",
  ...
  },
  {
    ...
    transfer_type: "EXTERNAL",
    amount: 890.00,
    recipient_name: "West Coast Vehicle Maintenance",
    recipient_bank: "Wells Fargo",
    recipient_account_number: "729104638",
  ...
  },
  {
    ...
    description: "Private Client Credit - Martin Alvarado Castillo",
    status: "COMPLETED",
  ...
  },
  {
    ...
    transfer_type: "EXTERNAL",
    amount: 45000.00,
    recipient_name: "Los Angeles Vehicle Services",
    recipient_bank: "Bank of America",
    recipient_account_number: "982741029",
    description: "Vehicle Payment - Los Angeles",
    status: "COMPLETED",
  ...
  },
  {
    ...
    description: "California DMV License Settlement",
    status: "COMPLETED",
  ...
  },
  {
    ...
    transfer_type: "EXTERNAL",
    amount: 450.00,
    recipient_name: "California Energy Grid",
  ...
  },
  {
    ...
    description: "Vehicle Service & Supplies LA",
    status: "COMPLETED",
  ...
  },
  {
    ...
    transfer_type: "EXTERNAL",
    amount: 4250.00,
    recipient_name: "LA Custom Freight",
